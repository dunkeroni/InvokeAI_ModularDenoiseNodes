...
class DemoFusionSDXLPipeline(DiffusionPipeline, FromSingleFileMixin, LoraLoaderMixin, TextualInversionLoaderMixin):
    ...
    def __init__(
        ...
        positive_pooled_embeds: torch.Tensor,
        ...
        self.positive_embeds = positive_embeds
        self.positive_pooled_embeds = positive_pooled_embeds
        self.negative_embeds = negative_embeds
        self.negative_pooled_embeds = negative_pooled_embeds
        self.register_to_config(force_zeros_for_empty_prompt=force_zeros_for_empty_prompt)
        self.vae_scale_factor = 2 ** (len(self.vae.config.block_out_channels) - 1)
        self.image_processor = VaeImageProcessor(vae_scale_factor=self.vae_scale_factor)
        self.default_sample_size = self.unet.config.sample_size #128
    ...
    # Copied from diffusers.pipelines.stasource_node_id
    ...
    def _get_add_time_ids(self, original_size, crops_coords_top_left, target_size, dtype):
        ...
        passed_add_embed_dim = (
            self.unet.config.addition_time_embed_dim * len(add_time_ids) + self.positive_pooled_embeds.shape[1] #self.text_encoder_2.config.projection_dim
        )
    ...
    def __call__(
        ...
        device = choose_torch_device() #self._execution_device
        ...
        pooled_prompt_embeds = self.positive_pooled_embeds
